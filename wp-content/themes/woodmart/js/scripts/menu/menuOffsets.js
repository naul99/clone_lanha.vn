...
(function ($) {
  woodmartThemeModule.menuOffsets = function () {
    var setOffset = function (li) {
      ...
      if (
        $dropdown.hasClass("wd-design-full-width") ||
        $dropdown.hasClass("wd-design-aside")
      ) {
        ...
        $dropdown.hasClass("wd-design-sized") ||
        $dropdown.hasClass("wd-design-default")
      ) {
        viewportWidth = woodmart_settings.site_width;

        if (
          woodmartThemeModule.$window.width() < viewportWidth ||
          !viewportWidth ||
          li.parents(".whb-header").hasClass("whb-full-width")
        ) {
          viewportWidth = woodmartThemeModule.$window.width();
        }
        ...
        var extraSpace = 15;
        var containerOffset =
          (woodmartThemeModule.$window.width() - viewportWidth) / 2;
    ...
    $(
      ".wd-header-main-nav ul.menu > li, .wd-header-secondary-nav ul.menu > li, .widget_nav_mega_menu ul.menu:not(.wd-nav-vertical) > li, .wd-header-main-nav .wd-dropdown.wd-design-aside ul > li"
    ).each(function () {
      var $menu = $(this);
