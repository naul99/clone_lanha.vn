...
(function ($) {
  woodmartThemeModule.headerBuilder = function () {
    ...
    if (
      $header.hasClass("whb-sticky-real") ||
      ...
      if ($header.hasClass("whb-sticky-real")) {
        // if no sticky rows
        if (
          $firstSticky.length === 0 ||
          $firstSticky[0].offsetHeight < 10 ||
