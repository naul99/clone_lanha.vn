...
(function ($) {
  ...
  woodmartThemeModule.removeDuplicatedStylesFromHTML = function (
    html,
    callback
  ) {
    ...
    $links.each(function () {
      ...
      if (
        "undefined" === typeof woodmart_page_css[id] &&
        !isThemeSettingsDefault
      ) {
        $("head").append(
  ...
  woodmartThemeModule.wdElementorAddAction(
    ...
    function ($wrapper) {
      if (
        $wrapper.attr("style") &&
        $wrapper.attr("style").indexOf("transform:translate3d") === 0 &&
        !$wrapper.hasClass("wd-parallax-on-scroll")
      ) {
        $wrapper.attr("style", "");
      }
      $wrapper.removeClass("wd-animated");
    ...
    if ("enabled" === woodmart_settings.elementor_no_gap) {
      elementorFrontend.hooks.addAction(
        ...
        function ($wrapper) {
          ...
          if (
            typeof elementorFrontend.config.elements.data[cid] !== "undefined"
          ) {
            var size =
